...
function alefal_torneodeirionistorici_options() {
	...
	echo 'CLASSIFICA: <br />';
	echo '<b><i>http://HOST_URL/wp-content/plugins/alefal_torneodeirionistorici/ranking.php?league_id=X&season_id=Y</i></b> <br />';
	echo '<br />';
	
	echo 'MATCHS: <br />';
	echo '<b><i>http://HOST_URL/wp-content/plugins/alefal_torneodeirionistorici/matchs.php?league_id=X&season_id=Y</i></b> <br />';
	echo '<br />';
