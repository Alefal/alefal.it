...
/*
http://localhost/alefal.it/PROJECTS/wordpress/wc-api/v3/products/categories?
	oauth_consumer_key=ck_9c1524eb8a0ef5666bd83c5122fff7eee7ae5450&
	oauth_timestamp=10000&
	oauth_nonce=false&
	oauth_signature=cs_2d48c0fdd44f22a2301f29d20115dbc9206ba119&
...
try {
	...
	$consumer_key 		= 'ck_9c1524eb8a0ef5666bd83c5122fff7eee7ae5450';
	$consumer_secret 	= 'cs_2d48c0fdd44f22a2301f29d20115dbc9206ba119';

	$client = new WC_API_Client( 'http://localhost', $consumer_key, $consumer_secret, $options );
	$oauth = base64_encode( $consumer_key . ':' . $consumer_secret );
	print_r( $oauth );
