      ...
      <div className="navbar-default sidebar" style={{ marginLeft: '-20px' }} role="navigation">
        <div className="sidebar-nav navbar-collapse collapse">
          <ul className="nav in" id="side-menu">
            ...
            <li>
              <a href="" onClick={(e) => { e.preventDefault(); history.push('/redux'); }} >
                <i className="fa fa-cogs fa-fw" /> &nbsp;Redux
              </a>
            </li>
            <li>
              <a href="" onClick={(e) => { e.preventDefault(); history.push('/hooks'); }} >
                <i className="fa fa-cogs fa-fw" /> &nbsp;Hooks
              </a>
            </li>
