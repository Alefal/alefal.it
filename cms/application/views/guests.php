          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              foreach($results as $row) {
                ...
                echo '<td>'.$row->city.'</td>';
                echo '<td align="right"><span class="glyphicon glyphicon-pencil" ng-click="editItem(\''.$row->id.'\',\''.$nameEl.'\',\''.$addressEl.'\',\''.$cityEl.'\')"></span> <a href="'.base_url().'index.php/guests/delete?idGuest='.$row->id.'" onclick="return confirm(\'Are you sure ?\')"><span class="glyphicon glyphicon-remove"></span></a></td>';
                echo '<tr>';
              }
              ?>
            </tbody>
