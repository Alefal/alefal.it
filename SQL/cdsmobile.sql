...
(1, 7, '1.p', '7-14', 'Sostava con il veicolo indicato in area Vietata', '', 'Sosta Vietata', 41.00, 0, 0),
(2, 157, '6.b', '2-3', 'Sostava con il veicolo indicato in area a pagamento senza mettere in f', '', 'TICKET OMESSO', 41.00, 0, 0);
...
CREATE TABLE IF NOT EXISTS `p_verb` (
  ...
  `TIPO_VEI_VERB` varchar(3) NOT NULL,
  ...
  `ID_ART1_VERB` int(11) NOT NULL,
  `COD1_VERB` varchar(5) NOT NULL,
  `DESCR_ART1_VERB` varchar(70) NOT NULL,
  `ID_ART2_VERB` int(11) NOT NULL,
  `COD2_VERB` varchar(5) NOT NULL,
  `DESCR_ART2_VERB` varchar(70) NOT NULL,
