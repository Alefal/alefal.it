jQuery.fn.laradrop = function(options) {	
    ...
    var laradropObj = jQuery(this),
		fileHandler = options.fileHandler ? options.fileHandler : ( laradropObj.attr('laradrop-upload-handler') ? laradropObj.attr('laradrop-upload-handler') : '/costaeventi/backend/laradrop'),
    	fileDeleteHandler = options.fileDeleteHandler ? options.fileDeleteHandler : ( laradropObj.attr('laradrop-file-delete-handler') ? laradropObj.attr('laradrop-file-delete-handler') : '/costaeventi/backend/laradrop/0'),
    	fileSrc = options.fileSrc ? options.fileSrc : ( laradropObj.attr('laradrop-file-source') ? laradropObj.attr('laradrop-file-source') : '/costaeventi/backend/laradrop'),
    	fileCreateHandler = options.fileCreateHandler ? options.fileCreateHandler : ( laradropObj.attr('laradrop-file-create-handler') ? laradropObj.attr('laradrop-file-create-handler') : '/costaeventi/backend/laradrop/create'),
    	fileMoveHandler = options.fileMoveHandler ? options.fileMoveHandler : ( laradropObj.attr('laradrop-file-move-handler') ? laradropObj.attr('laradrop-file-move-handler') : '/costaeventi/backend/laradrop/move'),
    	containersUrl = options.containersUrl ? options.containersUrl : ( laradropObj.attr('laradrop-containers') ? laradropObj.attr('laradrop-containers') : '/costaeventi/backend/laradrop/containers'),
        ...
        folderImage = options.folderImage ? options.folderImage : '/costaeventi/backend/vendor/jasekz/laradrop/img/genericThumbs/folder.png',
