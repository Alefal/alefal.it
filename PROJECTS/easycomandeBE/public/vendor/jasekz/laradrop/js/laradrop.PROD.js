jQuery.fn.laradrop = function(options) {	
    ...
    var laradropObj = jQuery(this),
		fileHandler = options.fileHandler ? options.fileHandler : ( laradropObj.attr('laradrop-upload-handler') ? laradropObj.attr('laradrop-upload-handler') : '/cicos/BE/public/laradrop'),
    	fileDeleteHandler = options.fileDeleteHandler ? options.fileDeleteHandler : ( laradropObj.attr('laradrop-file-delete-handler') ? laradropObj.attr('laradrop-file-delete-handler') : '/cicos/BE/public/laradrop/0'),
    	fileSrc = options.fileSrc ? options.fileSrc : ( laradropObj.attr('laradrop-file-source') ? laradropObj.attr('laradrop-file-source') : '/cicos/BE/public/laradrop'),
    	fileCreateHandler = options.fileCreateHandler ? options.fileCreateHandler : ( laradropObj.attr('laradrop-file-create-handler') ? laradropObj.attr('laradrop-file-create-handler') : '/cicos/BE/public/laradrop/create'),
    	fileMoveHandler = options.fileMoveHandler ? options.fileMoveHandler : ( laradropObj.attr('laradrop-file-move-handler') ? laradropObj.attr('laradrop-file-move-handler') : '/cicos/BE/public/laradrop/move'),
    	containersUrl = options.containersUrl ? options.containersUrl : ( laradropObj.attr('laradrop-containers') ? laradropObj.attr('laradrop-containers') : '/cicos/BE/public/laradrop/containers'),
        ...
        folderImage = options.folderImage ? options.folderImage : '/cicos/BE/public/vendor/jasekz/laradrop/img/genericThumbs/folder.png',
