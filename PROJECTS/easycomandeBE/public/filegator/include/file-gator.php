...
class gator {
	...
	public static function error($message){
		...
		if (strpos($_SERVER[HTTP_HOST], 'amalficoastapps.it') !== false) {
			echo "<div class=\"warning\"><strong>{$message}</strong></div><a href=\"/costaeventi/backend/filegator/index.php?logout=1\">".lang::get("Sign in")."</a>";
		} else {
			echo "<div class=\"warning\"><strong>{$message}</strong></div><a href=\"/filegator/index.php?logout=1\">".lang::get("Sign in")."</a>";			
		}
