...
$(document).ready(function() {
    ...
    $('.mobile-actions.sign-out').click(function(){
		...
		?>
			output += '<a href="/costaeventi/backend/filegator/index.php?logout=1"><button type="button" class="nice radius button"><?php echo lang::get("Sign out")?></button></a>';
 		<?php
		} else {
		?>
			output += '<a href="/filegator/index.php?logout=1"><button type="button" class="nice radius button"><?php echo lang::get("Sign out")?></button></a>';
 		<?php
		}
		?>
