...
<div class="row">
 ...
 | 
 	<?php
    if (strpos($_SERVER[HTTP_HOST], 'amalficoastapps.it') !== false) {
    ?>
        <a href="/costaeventi/backend/filegator/index.php?logout=1"><?php echo lang::get("Sign out")?></a>
    <?php
    } else {
    ?>
        <a href="/filegator/index.php?logout=1"><?php echo lang::get("Sign out")?></a>    
    <?php
    }
    ?>
</div>
...
<div class="row">
 <div class="container twelve columns">
    ...
    if (strpos($_SERVER[HTTP_HOST], 'amalficoastapps.it') !== false) {
    ?>
        <a href="/costaeventi/backend/filegator/index.php?logout=1" class="mobile-actions sign-out"></a>
    <?php
    } else {
    ?>
        <a href="/filegator/index.php?logout=1" class="mobile-actions sign-out"></a>
    <?php
    }
    ?>
