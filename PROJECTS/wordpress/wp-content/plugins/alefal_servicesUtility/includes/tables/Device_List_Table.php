...
class Device_List_Table extends WP_List_Table {
    ...
    function column_ID($item) {
		$actions = array(
			'edit'      => sprintf('<a href="?page=alefal_servicesUtility-device-page&action=%s&id=%s">Edit</a>','edit',$item['id']),
    ...
    function get_sortable_columns() {
        return array('registerModel' => array('registerModel', false));
    }
    ...
    function prepare_items() {
        global $wpdb; 
        $kv_query = "SELECT * FROM alfl_register_device";
        $per_page = 5;
