...
function woo_ce_get_shipping_class_fields( $format = 'full' ) {
	...
	$fields[] = array(
		'name' => 'name',
		'label' => __( 'Shipping Class Name', 'woocommerce-exporter' )
	);
	$fields[] = array(
		'name' => 'slug',
		'label' => __( 'Shipping Class Slug', 'woocommerce-exporter' )
	);
	$fields[] = array(
		'name' => 'description',
		'label' => __( 'Shipping Class Description', 'woocommerce-exporter' )
	);
