...
function woo_ce_scheduled_export_widget_configure() {
...
function woo_ce_scheduled_export_banner( $post ) {
	...
	echo '<a href="' . esc_url( add_query_arg( array( 'page' => 'woo_ce', 'tab' => 'settings' ), 'admin.php' ) ) .'#scheduled-exports" class="button confirm-button" data-confirm="' . __( 'The changes you made will be lost if you navigate away from this page.', 'woocommerce-exporter' ) . '">' . __( 'Return to Settings', 'woocommerce-exporter' ) . '</a>';
...
function woo_ce_scheduled_export_filters_meta_box() {
	...
	if( !woo_ce_get_option( 'enable_auto', 0 ) ) {
		$override_url = esc_url( add_query_arg( array( 'page' => 'woo_ce', 'tab' => 'settings', 'action' => 'enable_scheduled_exports', '_wpnonce' => wp_create_nonce( 'woo_ce_enable_scheduled_exports' ) ), 'admin.php' ) );
