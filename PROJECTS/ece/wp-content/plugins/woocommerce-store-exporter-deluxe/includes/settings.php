		...
		<table class="widefat page fixed scheduled-exports">
			<thead>
				...
				<tr>
					...
					<th class="manage-column"><?php _e( 'Type', 'woocommerce-exporter' ); ?></th>
					<th class="manage-column"><?php _e( 'Format', 'woocommerce-exporter' ); ?></th>
					<th class="manage-column"><?php _e( 'Method', 'woocommerce-exporter' ); ?></th>
...
<?php if( !empty( $scheduled_exports ) ) { ?>
	<?php foreach( $scheduled_exports as $scheduled_export ) { ?>
				<tr id="post-<?php echo $scheduled_export; ?>">
					...
					<td>
						<a href="<?php echo add_query_arg( array( 'action' => 'override_scheduled_export', 'post' => $scheduled_export, '_wpnonce' => wp_create_nonce( 'woo_ce_override_scheduled_export' ) ) ); ?>" title="<?php _e( 'Run this scheduled export now', 'woocommerce-exporter' ); ?>" class="button<?php echo( get_post_status( $scheduled_export ) == 'draft' ? ' disabled' : '' ); ?>"><?php _e( 'Execute', 'woocommerce-exporter' ); ?></a>
					</td>
				</tr>
