			...
			<tr>
				...
				<td>
					<select id="line_ending" name="line_ending">
						<option value="windows"<?php selected( $line_ending_formatting, 'windows' ); ?>><?php _e( 'Windows', 'woocommerce-exporter' ); ?></option>
						<option value="mac"<?php selected( $line_ending_formatting, 'mac' ); ?>><?php _e( 'Mac' ,'woocommerce-exporter' ); ?></option>
						<option value="unix"<?php selected( $line_ending_formatting, 'unix' ); ?>><?php _e( 'Unix', 'woocommerce-exporter' ); ?></option>
					</select>
