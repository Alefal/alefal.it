 ...
 */
define ('TTL_EVENTS', 	'Events');
define ('TTL_NEWS', 	'Latest from the Blog');
define ('TTL_MEMBERS', 	'Minoresi');
define ('TTL_PARTNERS', 'Our Partners');
define ('TTL_CONTACT', 	'Contact');

define ('TXT_FAMIGLIA_TITOLO', 	'<span>Enter our</span>Family');
define ('TXT_FAMIGLIA_DESCR', 	'Want to be part too of our big family to share your experiences and emotions?');
define ('TXT_FAMIGLIA_BUTTON', 	'Contact');
