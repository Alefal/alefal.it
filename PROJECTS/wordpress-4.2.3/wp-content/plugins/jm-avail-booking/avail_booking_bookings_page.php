...
function Avail_Booking_Bookings_admin_menu() {
    ...
    $hook = add_menu_page(__('bookings', 'jm_avail_booking'), __('WP Availability Calendar & Bookings', 'jm_avail_booking'), $jm_capability, 'bookings', 'Avail_booking_Bookings_page_handler');
    add_action("load-$hook", 'avial_booking_add_option');
    add_submenu_page('bookings', __('WP Availability Calendar & Bookings', 'jm_avail_booking'), __('Bookings', 'jm_avail_booking'), $jm_capability, 'bookings', 'Avail_booking_Bookings_page_handler');
    add_submenu_page('bookings', __('Add new Booking', 'jm_avail_booking'), __('Add new Booking', 'jm_avail_booking'), $jm_capability, 'bookings_form', 'Avail_booking_Bookings_form_page_handler');
}
...
function Avail_booking_Bookings_page_handler() {
    ...
    <div class="wrap">
        ...
        <h1><?php _e('Bookings', 'jm_avail_booking') ?> <a class="page-title-action"
