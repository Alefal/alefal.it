...
function Avail_Booking_Prices_admin_menu() {
    ...
    $hook = add_submenu_page('bookings', __('WP Availability Calendar & Bookings', 'jm_avail_booking'), __('Prices', 'jm_avail_booking'), $jm_capability, 'prices', 'Avail_booking_Prices_page_handler');
    add_action("load-$hook", 'avial_booking_add_price_option');
    add_submenu_page('bookings', __('Add new Price', 'jm_avail_booking'), __('Add new Price', 'jm_avail_booking'), $jm_capability, 'prices_form', 'Avail_booking_Prices_form_page_handler');
}
...
function Avail_booking_Prices_page_handler() {
    ...
    ?>
    <div class="wrap">        
        <h1><?php _e('Prices', 'jm_avail_booking') ?> <a class="page-title-action"
