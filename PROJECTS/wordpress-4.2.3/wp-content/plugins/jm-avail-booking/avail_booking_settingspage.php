...
class Avail_Booking_SettingsPage {
    ...
    public function add_plugin_page() {
        ...
        add_submenu_page(
                'bookings', __('Settings', 'jm_avail_booking'), __('Settings', 'jm_avail_booking'), $jm_capability, 'jm_avail_booking-setting-admin', array($this, 'create_admin_page')
        );
    }
    ...
    public function page_init() {
        ...
        function jm_avail_booking_setting_page_capability($capability) {
            global $jm_capability; 
            return $jm_capability;
        }

        add_filter('option_page_capability_jm_avail_booking_option_group', 'jm_avail_booking_setting_page_capability');
        ...
        add_settings_field(
                'checkin_day', ' ' . __('Checkin Day', 'jm_avail_booking') . '', array($this, 'selection_dropdown_callback'), 'jm_avail_booking-setting-admin', 'booking_section_id', array(
        ...
        add_settings_field(
                'checkout_day', ' ' . __('Checkout Day', 'jm_avail_booking') . '', array($this, 'selection_dropdown_callback'), 'jm_avail_booking-setting-admin', 'booking_section_id', array(
            'options-name' => 'jm_avail_booking_option_name',
            'id' => 'checkout_day',
            'class' => '',
            'value' => array(
        ...
        add_settings_field(
                'status', ' ' . __('Status booking with ContactForm7', 'jm_avail_booking') . '', array($this, 'selection_dropdown_callback'), 'jm_avail_booking-setting-admin', 'form_section_id', array(
            'options-name' => 'jm_avail_booking_option_name',
            'id' => 'status',
            'class' => '',
            'value' => array(
        ...
        add_settings_section(
                ...
                '' . __('External Calendar Settings', 'jm_avail_booking') . '', // Title
                array($this, 'print_airbenb_section_info'), // Callback
                'jm_avail_booking-setting-admin' // Page
        );
        add_settings_field(
                'airbenb_confirmed', ' ' . __('Which status must block the external calendar', 'jm_avail_booking') . '', array($this, 'selection_dropdown_callback'), 'jm_avail_booking-setting-admin', 'airbenb_section_id', array(
            'options-name' => 'jm_avail_booking_option_name',
            ...
            'label' => __('Select value for blocking the external Calendar.', 'jm_avail_booking'),
        ));
        add_settings_field(
                'summary', ' ' . __('Which field must be mapped to the external Calendar Summary field', 'jm_avail_booking') . '', array($this, 'selection_dropdown_callback'), 'jm_avail_booking-setting-admin', 'airbenb_section_id', array(
            'options-name' => 'jm_avail_booking_option_name',
            'id' => 'summary',
            'class' => '',
            'value' => array(
            ...
            'label' => __('Select value to map to the external Calendar.', 'jm_avail_booking'),
        ));
        add_settings_field(
                'description', ' ' . __('Which field must be mapped to the external Calendar Descsription field', 'jm_avail_booking') . '', array($this, 'selection_dropdown_callback'), 'jm_avail_booking-setting-admin', 'airbenb_section_id', array(
            'options-name' => 'jm_avail_booking_option_name',
            'id' => 'description',
            'class' => '',
            'value' => array(
        ...
        add_settings_field(
                'external_links', ' ' . __('List of external upload links', 'jm_avail_booking') . '', array($this, 'external_links_callback'), 'jm_avail_booking-setting-admin', 'airbenb_section_id'
        );
        add_settings_field(
                'schedule_recurrance', ' ' . __('Schedule recurrance', 'jm_avail_booking') . '', array($this, 'selection_dropdown_callback'), 'jm_avail_booking-setting-admin', 'airbenb_section_id', array(
            'options-name' => 'jm_avail_booking_option_name',
            'id' => 'schedule_recurrance',
            'class' => '',
            'value' => array(                
                'hourly' => __('Hourly', 'jm_avail_booking'),
                'twicedaily' => __('Twicedaily', 'jm_avail_booking'),
            ),
            'label' => __('Select the schedule recurrance.', 'jm_avail_booking')
        ));
        // Default options
        add_settings_section(
        ...
        add_settings_field(
                'default_status', ' ' . __('Default Status', 'jm_avail_booking') . '', array($this, 'selection_dropdown_callback'), 'jm_avail_booking-setting-admin', 'default_section_id', array(
            'options-name' => 'jm_avail_booking_option_name',
            'id' => 'default_status',
            'class' => '',
            'value' => array(
        ...
        add_settings_field(
                'default_language', ' ' . __('Default Language', 'jm_avail_booking') . '', array($this, 'selection_dropdown_callback'), 'jm_avail_booking-setting-admin', 'default_section_id', array(
            'options-name' => 'jm_avail_booking_option_name',
            'id' => 'default_language',
            'class' => '',
            'value' => array(
    ...
    public function sanitize($input) {
        ...
        if (isset($input['external_links']))
            $new_input['external_links'] = sanitize_text_field($input['external_links']);
        if (isset($input['schedule_recurrance']))
            $new_input['schedule_recurrance'] = sanitize_text_field($input['schedule_recurrance']);
        //Defaults
    ...
    public function print_airbenb_section_info() {
        _e('This section controls the external synchronisation', 'jm_avail_booking');
        echo "</br></br>";
        ...
        if (isset($this->options['rooms']) AND ( $this->options['rooms']) != "") {
            ...
            _e('<strong>You have the following external Links:</strong> </br><br />', 'jm_avail_booking');
    ...
    public function external_links_callback() {
        echo '<textarea id="external_links" name="jm_avail_booking_option_name[external_links]" rows="5" cols="50">' . $this->options['external_links'] . '</textarea>';
        echo '<p>';
        _e('Give the available room>link combinatons. Format roomname1>link1,roomname2:link2 ', 'jm_avail_booking');
        echo '</p>';
    }
