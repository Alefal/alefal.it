...
<p style="font-size:0.8em;"><div class="dashicons dashicons-yes"></div>&nbsp;<strong><?php _e( 'Scheduled exports is enabled', 'woocommerce-exporter' ); ?></strong></p>
	...
	<?php if( !empty( $scheduled_exports ) ) { ?>
		<?php if( $next_export ) { ?>
<p><?php printf( __( 'The next scheduled export - %s - will run in %s.', 'woocommerce-exporter' ), sprintf( '<a href="' . get_edit_post_link( $next_export ) . '">%s</a>', woo_ce_format_post_title( get_the_title( $next_export ) ) ), woo_ce_get_next_scheduled_export( $next_export ) ); ?></p>
		<?php } ?>
...
<p><?php _e( 'No scheduled exports found.', 'woocommerce-exporter' ); ?></p>
	<?php } ?>
<?php } ?>
<p style="text-align:right;"><a href="<?php echo esc_url( add_query_arg( array( 'page' => 'woo_ce', 'tab' => 'settings' ), 'admin.php' ) ); ?>#scheduled-exports"><?php _e( 'View all scheduled exports', 'woocommerce-exporter' ); ?></a></p>