...
class leagueengine_data_table_rankings extends WP_List_Table {
    ...
    function column_default($item, $column_name){
        ...
        switch($column_name){
            ...
            case 'leagueengine_table_team': return leagueengine_fetch_team_emblem($item['team_id']) . '<a href="admin.php?page=leagueengine_team&id='. $item['team_id'] .'">' . leagueengine_fetch_data_from_id($item['team_id'],'data_value') . '</a>';
            case 'leagueengine_table_gp': return leagueengine_table_gp($_GET['lid'],$_GET['sid'],$item['team_id']);
            case 'leagueengine_table_gw': return leagueengine_table_gw($_GET['lid'],$_GET['sid'],$item['team_id']);
            case 'leagueengine_table_gl': return leagueengine_table_gl($_GET['lid'],$_GET['sid'],$item['team_id']);
            case 'leagueengine_table_gd': return leagueengine_table_gd($_GET['lid'],$_GET['sid'],$item['team_id']);
            case 'leagueengine_table_gf': return leagueengine_table_gf($_GET['lid'],$_GET['sid'],$item['team_id']);
            case 'leagueengine_table_ga': return leagueengine_table_ga($_GET['lid'],$_GET['sid'],$item['team_id']);
            case 'leagueengine_table_diff': return leagueengine_table_diff($_GET['lid'],$_GET['sid'],$item['team_id']);
            case 'leagueengine_table_bp': return leagueengine_table_bp($_GET['lid'],$_GET['sid'],$item['team_id']);
            case 'leagueengine_table_pts':
				...
				$wpts = leagueengine_table_gw($_GET['lid'],$_GET['sid'],$item['team_id'])*$league_settings->pts_win;
				$lpts = leagueengine_table_gl($_GET['lid'],$_GET['sid'],$item['team_id'])*$league_settings->pts_lose;
				$dpts = leagueengine_table_gd($_GET['lid'],$_GET['sid'],$item['team_id'])*$league_settings->pts_draw;
				$totalpts = $wpts + $lpts + $dpts + leagueengine_table_bp($_GET['lid'],$_GET['sid'],$item['team_id']);
            	return $totalpts;
            default:
