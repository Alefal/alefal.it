...
@Component({
  selector: 'app-testslickgrid',
  templateUrl: './testslickgrid.component.html',
  styleUrls: ['./testslickgrid.component.scss']
})
export class TestslickgridComponent implements OnInit {
